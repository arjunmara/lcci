            ...
            <div class="author-profile-meta-wrap">
                <div class="author-profile-meta">
                    ...
                    <div class="author-profile-info">
                        ...
                        <!-- AUTHOR PROFILE INFO ITEM -->
                        <div class="author-profile-info-item">
                            <p class="text-header">Position:</p>
                            <p>Member</p>
                        </div>
                        <!-- /AUTHOR PROFILE INFO ITEM -->
                        ...
                        <div class="author-profile-info-item">
                            ...
                            <p><a href="http://www.arjundesigns.com/" class="primary">www.arjundesigns.com</a></p>
                        </div>
                        <!-- /AUTHOR PROFILE INFO ITEM -->
                    </div>
                    <!-- /AUTHOR PROFILE INFO -->
                ...
                <div class="section overflowable">
                        ...
                        <div class="sidebar-item author-bio">
                            ...
                            <a href="user-profile.html" class="user-avatar-wrap medium">
                                <figure class="user-avatar medium">
                                    <img src="../assets/images/avatars/avatar_09.jpg" alt="">
                                </figure>
                            </a>
                            <!-- /USER AVATAR -->
                            <p class="text-header">Arjun Design</p>
                            <p class="text-oneline">Super Samurai Developers<br>Ktm Nepal</p>
                            <!-- SHARE LINKS -->
                        ...
                        <div class="product-list grid column3-4-wrap">
                            ...
                            <div class="product-item column">
                                ...
                                <div class="product-preview-actions">
                                    ...
                                    <figure class="product-preview-image">
                                        <img src="../assets/images/items/miniverse_m.jpg" alt="product-image">
                                    </figure>
                                    <!-- /PRODUCT PREVIEW IMAGE -->
                                ...
                                <div class="user-rating">
                                    <a href="author-profile.html">
                                        <figure class="user-avatar small">
                                            <img src="../assets/images/avatars/avatar_09.jpg" alt="user-avatar">
                                        </figure>
                                    </a>
                                    <a href="author-profile.html">
                            ...
                            <div class="product-item column">
                                ...
                                <div class="product-preview-actions">
                                    <!-- PRODUCT PREVIEW IMAGE -->
                                    <figure class="product-preview-image">
                                        <img src="../assets/images/items/phantom_m.jpg" alt="product-image">
                                    </figure>
                                    <!-- /PRODUCT PREVIEW IMAGE -->
                    ...
                    <div class="content right" id="mem-list" v-if="!profile">
                        ...
                        <div class="follow-list">
                            <!-- FOLLOW LIST ITEM -->
                            <div class="follow-list-item" v-for="item in members" :key="item.id">
                                <a href="author-profile.php">
                                    <figure class="user-avatar medium liquid">
                                        <img src="../assets/images/avatars/avatar_03.jpg" alt="">
                                    </figure>
                                </a>

                                <!-- FL ITEM INFO -->
                                <div class="fl-item-info fl-description">
                                    <p class="text-header"><a href="author-profile.php">{{item.name}}</a></p>
                                    <p>Member since October 8th, 2018</p>
                                    <p>Kathmandu</p>
                                </div>
                                <!-- /FL ITEM INFO -->
                                ...
                                <div class="fl-item-info fl-reputation">
                                    <p class="text-header">{{item.position}}</p>
                                    <!-- RATING -->
                                    <ul class="rating">
                                        <li class="rating-item">
                                            <!-- SVG STAR -->
                                ...
                                <div class="fl-item-info fl-button">
                                    <a href="#" class="button mid-short dark"><span class="primary">Edit Member</span></a>
                                </div>
                                <!-- /FL ITEM INFO -->
                            </div>
                            <!-- /FOLLOW LIST ITEM -->
  ...
  data: function() {
    return {
      ...
      members: [
        ...
        { name: "Santosh Dhakal", position: "Director" },
        { name: "Arjun Marasini", position: "Manager" }
      ]
    };
  },
